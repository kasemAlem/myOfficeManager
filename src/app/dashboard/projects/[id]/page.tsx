...
import {
  ...
  HardDrive, Copy, ExternalLink
} from 'lucide-react';
import Link from 'next/link';

type Tab = 'overview' | 'contacts' | 'financial' | 'timeline' | 'artifacts';
...
export default function ProjectDetailPage() {
  ...
  const inputStyle = {
    ...
    color: 'white', width: '100%', boxSizing: 'border-box' as const
  };
                  ...
                  {editingMilestoneNotesId === m.id ? (
                    <div style={{ display: 'flex', flexDirection: 'column', gap: '0.75rem' }}>
                      ...
                      <textarea
                        ...
                        style={{
                          width: '100%', minHeight: '200px', background: '#000', border: '1px solid var(--accent-warning)',
                          color: '#0f0', fontFamily: 'monospace', fontSize: '0.85rem', padding: '1rem', outline: 'none', resize: 'vertical',
                          lineHeight: '1.5'
                        }}
                      />
                    </div>
